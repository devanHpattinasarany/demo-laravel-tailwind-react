        ...
        <div className="max-w-6xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Bergabunglah dalam festival yang memadukan <span className="text-orange-600 font-semibold">kreativitas UMKM lokal</span> dengan 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-8">
            <div className="group bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 rounded-2xl p-6 hover:from-orange-100 hover:to-orange-150 hover:border-orange-300 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="font-bold text-xl text-orange-800">UMKM Showcase</h3>
                  <p className="text-sm text-orange-700 leading-relaxed">
                    Jelajahi produk-produk kreatif dan berkualitas dari UMKM terbaik Maluku
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-6 hover:from-red-100 hover:to-red-150 hover:border-red-300 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="font-bold text-xl text-red-800">Inspiring Talks</h3>
                  <p className="text-sm text-red-700 leading-relaxed">
                    Dengarkan kisah sukses dan tips dari entrepreneur dan pembicara inspiratif
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="pt-8 space-y-4">
            <p className="text-sm text-muted-foreground font-medium">
              Event gratis untuk semua kalangan • Registrasi online mudah dan cepat
            </p>
