...
interface SeminarShowProps {
  seminar: Seminar;
  relatedSeminars: RelatedSeminar[];
  meta: {
    title: string;
    description: string;
    keywords: string;
...
export default function SeminarShow({ seminar, relatedSeminars, meta }: SeminarShowProps) {
              ...
              <div className="lg:col-span-2">
                <div className="relative group">
                  ...
                  <div className="absolute top-6 left-6">
                    ...
                    {!seminar.is_today && !seminar.is_tomorrow && seminar.days_until <= 7 && (
                ...
                <div className="bg-white/90 backdrop-blur-sm border border-orange-100 rounded-2xl shadow-xl p-8 space-y-8 sticky top-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-900">{seminar.formatted_date}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-900">{seminar.formatted_time}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-900 text-sm leading-relaxed">{seminar.location}</p>
                        </div>
                      </div>
                      ...
                      {seminar.speakers && (
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-gray-900 text-sm leading-relaxed">{seminar.speakers}</p>
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200 rounded-xl p-6">
                    <div className="text-center space-y-4">
                      ...
                      {/* Registration CTA */}
                      {seminar.can_register && !seminar.is_full ? (
                        <Button 
                          size="lg" 
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between py-3 border-b border-gray-100">
                        ...
                        <span className="font-bold text-gray-900">{seminar.registration_count} orang</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between py-3 border-b border-gray-100">
                        ...
                        <span className="font-bold text-green-700">{seminar.available_slots} slot</span>
                      </div>
                    </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {relatedSeminars.map((relatedSeminar, index) => (
                    <Link key={relatedSeminar.id} href={`/seminars/${relatedSeminar.id}`}>
                      <div className={`group relative overflow-hidden rounded-2xl bg-white border border-orange-200 hover:border-orange-300 hover:shadow-xl transition-all duration-300 h-64 ${index % 2 === 0 ? 'hover:-translate-y-2' : 'hover:translate-y-2'}`}>
                        ...
                        <div className="absolute inset-0">
                          <img
                            src={relatedSeminar.poster_url}
                            alt={relatedSeminar.title}
                        ...
                        <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-white/90">
                              ...
                              <span className="text-sm font-medium">{relatedSeminar.registration_count} peserta</span>
                            </div>
